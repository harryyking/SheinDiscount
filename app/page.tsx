              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                ...
                <p className="mt-6 text-xl text-gray-600 max-w-2xl">
                  ...
                  <Button size="lg" className="px-8 py-6 mt-4">
                    ...
                    <Link href="/main " className="text-lg flex items-center gap-4">
            ...
            <div className="space-y-8 grid md:grid-cols-2 gap-16">
              {features.map((feature) => (
                <div key={feature.title}>
                    <div
                      className="p-3 rounded-full  bg-primary/10 text-primary w-16"
                    >
                      {feature.icon}
                    </div>
                    <div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-100 transition-all hover:shadow-md">
              <div className="p-4 bg-primary/5">
                <img src="https://img.freepik.com/free-vector/illustration-data-analysis-graph_53876-17905.jpg?semt=ais_hybrid?height=200&width=300" alt="Bar chart example" className="w-full rounded" />
              </div>
              <div className="p-6">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-100 transition-all hover:shadow-md">
              <div className="p-4 bg-primary/5">
                <img src="https://img.freepik.com/free-vector/illustration-data-analysis-graph_53876-17902.jpg?semt=ais_hybrid?height=200&width=300" alt="Line chart example" className="w-full rounded" />
              </div>
              <div className="p-6">
                <div className="flex items-center gap-2 mb-2">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-100 transition-all hover:shadow-md">
              <div className="p-4 bg-primary/5">
                <img src="https://img.freepik.com/free-vector/3d-pie-chart-3_78370-628.jpg?semt=ais_hybrid?height=200&width=300" alt="Pie chart example" className="w-full rounded" />
              </div>
              <div className="p-6">
                <div className="flex items-center gap-2 mb-2">
